...
class TestContainerProtocol(unittest.TestCase):
    ...
    def test_negative_not_contained(self):
        self.assertFalse(7 not in self.s)
...
class TestSequenceProtocol(unittest.TestCase):
    ...
    def test_repetition_nonzero_right(self):
        s = SortedSet([1, 2, 3])
        self.assertEqual(s * 100, SortedSet([1, 2, 3]))
    ...
    def test_repetition_nonzero_left(self):
        s = SortedSet([1, 2, 3])
        self.assertEqual(100 * s, SortedSet([1, 2, 3]))
...
class TestReprProtocol(unittest.TestCase):
    ...
    def test_repr_non_empty(self):
        s = SortedSet([3, 1, 5])
        self.assertEqual(repr(s), "SortedSet([1, 3, 5])")
